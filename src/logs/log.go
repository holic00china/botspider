...
func loadAppConfig() {
    ...
    <outputs formatid="main">
        ...
        <filter levels="info,critical">
            <rollingfile formatid="info" type="size" filename="../log/info.log" maxsize="100000000" maxrolls="100" />
        </filter>
        <filter levels="critical,error">
			<rollingfile formatid="critical" type="size" filename="../log/critical.log" maxsize="100000000" maxrolls="100" />
        </filter>
    </outputs>
    <formats>
